...
class HttpHelper
{
   ...
   */
  public static function validarPost($matarRequisicao = true, $allowOrigin = "*" ,$allowHeaders = "Authorization, Content-Type, Cache-Control")
  {
   ...
   * @return bool Se $matarRequisicao = false, o retorno informa se a validacao deu certo com TRUE/FALSE.
   */
  public static function validarGet($matarRequisicao = true, $allowOrigin = "*" ,$allowHeaders = "Authorization, Content-Type, Cache-Control")
  {
    header("Access-Control-Allow-Origin: $allowOrigin", true);
   ...
   * @return bool Se $matarRequisicao = false, o retorno informa se a validacao deu certo com TRUE/FALSE.
   */
  public static function validarMetodo($metodo, $matarRequisicao = true, $allowOrigin = "*" , $allowHeaders = "Authorization, Content-Type, Cache-Control")
  {
   ...
   * @return bool Se $matarRequisicao = false, o retorno informa se a validacao deu certo com TRUE/FALSE.
   */
  public static function validarMetodos($metodos = array('GET', 'POST', 'PUT', 'DELETE'), $matarRequisicao = true, $allowOrigin = "*" , $allowHeaders = "Authorization, Content-Type, Cache-Control")
  {
   ...
   * @param bool $inline
   */
  public static function downloadBinary($binaryString, $contentType, $contentLength, $filename, $inline = false) {
